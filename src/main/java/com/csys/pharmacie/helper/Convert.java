...
public abstract class Convert {
            ...
            while (rang > 0) {
                ...
                switch (Integer.parseInt(cent)) {
                    ...
                    case 2:
                        ...
                        break;
                    default:
                        result += " \u0648" + n1[Integer.parseInt(cent)] + " \u0645\u0627\u0626\u0629";	//�� ����
                }
    ...
    public static String FR(String nombre) {
        return FR(nombre, "Dinars Alg�riens", "Centimes");
    }

    public static String EN(String nombre, String devise, String sou) {
        String[] n1 = {"", " One", " Two", " Three", " Four", " Five", " Six", " Seven", " Eight", " Nine", " Ten", " Eleven", " Twelve ", " Thirteen ", " Fourteen ", " Fifteen ", " Sixteen ", " Seventeen ", " Eighteen ", " Nineteen "},
                n70 = {" Seventy-one", " Seventy-two", " Seventy-three", " Seventy-Fourteen", " Seventy-five", " Seventy-six", " Seventy-seven", " Seventy-seven", " Seventy-Eight", " Seventy-Nine"},
                n90 = {" Ninety-one", " Ninety-two", " Ninety-three", " Fourty-Fourteen", " Ninety-five", " Ninety-six", " Ninety-seven", " Ninety-eight", " Ninety-Nine"},
                n10 = {"", " Ten", " Twenty", " Thirty", " Forty", " Fifty", " Sixty", " Seventy", " Eighty", " Ninety"},
                n1000 = {"", " Thousand", " Million", " Billion", " Billion", " Billiard"};
        nombre = traiter(nombre);
        if ((nombre.equals("#Erreur")) || (nombre.equals("#Trop grand"))) {
            result = nombre;
        } else {
            ...
            while (rang > 0) {
                ...
                switch (Integer.parseInt(cent)) {
                    ...
                    case 1:
                        ...
                        break;
                    default:
                        result += n1[Integer.parseInt(cent)] + " Hundred";
                }
                switch (Integer.parseInt(dec)) {
                    case 0:
                        if (!cent.equals("0")) {
                    ...
                    default:
                        if ((!dix.equals("0")) && (un.equals("1"))) {
                            result += n10[Integer.parseInt(dix)] + " and a" + n1000[rang - 1];
                        } else {
                            result += n10[Integer.parseInt(dix)] + n1[Integer.parseInt(un)] + n1000[rang - 1];
                        }
                }
            ...
            switch (Integer.parseInt(frac)) {
                ...
                default:
                    if ((!dix.equals("0")) && (un.equals("1"))) {
                        result += n10[Integer.parseInt(dix)] + " and a " + sou;
                    } else {
                        result += n10[Integer.parseInt(dix)] + n1[Integer.parseInt(un)] + " " + sou;
                    }
            }
    ...
    public static String EN(String nombre) {
        return EN(nombre, "pounds", "penny");
    }
}
