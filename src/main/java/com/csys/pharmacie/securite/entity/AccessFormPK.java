...
public class AccessFormPK implements Serializable {
    ...
    public AccessFormPK(String module, String grp, String form, String control) {
        this.module = module;
        this.grp = grp;
        this.form = form;
    ...
    public String toString() {
        return "com.csys.pharmacie.securite.entity.AccessFormPK[ module=" + module + ", grp=" + grp + ", form=" + form + ", control=" + control + " ]";
    }
