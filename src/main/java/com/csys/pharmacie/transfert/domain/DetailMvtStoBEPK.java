 ...
 */
@Embeddable
public class DetailMvtStoBEPK implements Serializable {
    ...
    public DetailMvtStoBEPK() {
    }

    public DetailMvtStoBEPK(long codeDepsto, long codeArticle, String numbon, String numorder) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DetailMvtStoBEPK)) {
            return false;
        }
        DetailMvtStoBEPK other = (DetailMvtStoBEPK) object;
