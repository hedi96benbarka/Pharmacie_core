 ...
 */
@Embeddable
public class MvtStoBEPK implements Serializable {
    ...
    public MvtStoBEPK(Integer codart, String numbon, String numordre) {
        this.codart = codart;
        this.numbon = numbon;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MvtStoBEPK)) {
            return false;
        }
        MvtStoBEPK other = (MvtStoBEPK) object;
    ...
    public String toString() {
        return "com.csys.pharmacie.transfert.entity.MvtStoBEPK[ codart=" + codart + ", numbon=" + numbon + " ]";
    }
