 ...
 */
@Embeddable
public class MvtStoAVPK implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MvtStoAVPK)) {
            return false;
        }
        MvtStoAVPK other = (MvtStoAVPK) object;
    ...
    public String toString() {
        return "com.csys.pharmacie.transfert.entity.MvtStoAVPK[ codart=" + codart + ", numbon=" + numbon + " ]";
    }
